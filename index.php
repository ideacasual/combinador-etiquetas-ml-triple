...
<head>
    ...
    <meta name="description" content="Ahorrá papel al imprimir tus etiquetas no autoadhesivas en hoja A4. Procesa PDFs localmente en tu navegador.">
    <link rel="stylesheet" href="css/styles.css">
    
    <!-- Preload PDF.js worker for faster processing -->
    <link rel="preload" 
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Ahorrá papel al imprimir tus etiquetas de Mercado Libre en hojas A4</p>
        </div>
        <main> 
        <div class="main-content">
            ...
            <div class="action-buttons">
                <button class="process-btn process-sets" id="processSetsBtn" disabled>
                    Procesar como Conjuntos
                </button>
                <button class="process-btn" id="processSinglesBtn" disabled>
            ...
            <div class="instructions">
                ...
                <ul>
                    ...
                    <li>Elegí procesar como <strong>Conjuntos</strong> (agrupación de hasta 3 etiquetas por página) o <strong>Individuales</strong> (una etiqueta por página)</li>
        ...
        <div class="github-minimal-footer">
            <p class="footer-text">
                ...
                <a href="https://github.com/ideacasual/combinador-etiquetas-ml-triple" 
                   target="_blank" 
